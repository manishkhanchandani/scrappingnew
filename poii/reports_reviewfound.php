...
mysql_select_db($database_conn, $conn);
$query_rsView = sprintf("SELECT * FROM poii_xml WHERE country = '%s' AND gotit = 1 AND totalreview > 0 and flag = 1 and poi_id != 0", $colname_rsView);
