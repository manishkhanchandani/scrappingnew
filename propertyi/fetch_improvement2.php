...
// improvement in the search where search result is based on country
$time_start = microtime(true);
$Property = new Property;
$limit = $_GET['limit']; if(!$limit) $limit = 25;
echo $sql = "SELECT * FROM property_xml WHERE gotit = 1 AND (ftype = 'country' or ftype = 'country_2') and improvement2 = 0 limit $limit";
echo "<br>";
...
if(mysql_num_rows($rs)) {
	while($rec = mysql_fetch_array($rs)) {
		...
		echo $sql = "update property_xml set improvement2 = 1 where id = '".$rec['id']."'";
