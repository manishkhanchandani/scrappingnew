...
mysql_select_db($database_conn, $conn);
$query_rsView = sprintf("SELECT * FROM property_xml WHERE country = '%s' AND gotit = 1 AND totalreview < 1 and flag = 1 and hotel_id != 0", $colname_rsView);
  ...
  <table border="1" cellpadding="5" cellspacing="0">
    ...
    <?php do { ?>
      <tr>
        ...
        <td><a href="<?php echo $row_rsView['firsturl']; ?>" target="_blank"><?php echo $row_rsView['firsturl']; ?></a></td>
        <td><?php echo $row_rsView['ftype']; ?></td>
        <td><?php echo $row_rsView['heading']; ?></td>
        <td><?php echo $row_rsView['avgrating']; ?></td>
        <td><?php echo $row_rsView['totalreview']; ?></td>
